...
{
    public partial class FormINSSpecialnost : Form
    {
        private SqlConnection sqlConnection = null;
        public FormINSSpecialnost()
        {
            InitializeComponent();
        }
        ...
        private void buttonINS_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("INSERT INTO [Specialnost] (Name)VALUES(@Name)", sqlConnection);
        ...
        private void FormINSSpecialnost_Load(object sender, EventArgs e)
        {
            sqlConnection = new SqlConnection(@"Data Source=LAPTOP-BE5REM0B;Initial Catalog=Uchet_uspevaem;Integrated Security=True");
            sqlConnection.Open();
        }
