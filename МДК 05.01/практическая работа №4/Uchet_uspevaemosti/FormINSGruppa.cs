...
{
    public partial class FormINSGruppa : Form
    {
        private SqlConnection sqlConnection = null;
        public FormINSGruppa()
        {
            InitializeComponent();
        }
        ...
        private void buttonINS_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("INSERT INTO [Gruppa] (Name)VALUES(@Name)", sqlConnection);
        ...
        private void FormINSGruppa_Load(object sender, EventArgs e)
        {
            sqlConnection = new SqlConnection(@"Data Source=LAPTOP-BE5REM0B;Initial Catalog=Uchet_uspevaem;Integrated Security=True");
            sqlConnection.Open();
        }
